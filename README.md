...
2. Run 'make pipeline' the same way.
3. Run 'make dashboard', which will then start a local Streamlit server.
4. **Ctrl+click** on the Local URL link, and your dashboard should open in a new tab! This contains parts 2-4 of the analysis.
